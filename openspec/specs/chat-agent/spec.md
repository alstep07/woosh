...
## Purpose
The Woosh Agent chat interface: a Claude-powered assistant (via OpenRouter) with
tool-calling for balance, history, payments, invoices, strategies, and swaps, using a
confirm-before-execute pattern for anything that moves funds.
## Requirements
